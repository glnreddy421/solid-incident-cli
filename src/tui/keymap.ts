...
export const KEYMAP: KeyAction[] = [
  ...
  { key: "n", description: "BYO follow-up picker (then 1–7, 0/Esc cancel); needs --provider + primary AI" },
  { key: "R", description: "Snapshot engine RCA into Reports (panel 8); uses current analysis" },
  { key: "I", description: "Snapshot STAR interview into Reports (panel 8)" },
